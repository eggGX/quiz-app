...
function showCriticalError(details) {
  ...
  const detailText = details.length ? `不足パーツ: ${details.join(", ")}` : "";
  container.innerHTML = `
    <h2>画面を読み込めませんでした</h2>
    <p>最新のファイル構成と異なるため、アプリの初期化に失敗しました。</p>
    ${detailText ? `<p class="app-error__details">${detailText}</p>` : ""}
    <p>最新版の <code>index.html</code> / <code>app.js</code> / <code>styles.css</code> を取得し直してから、もう一度お試しください。</p>
  `;
